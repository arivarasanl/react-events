...
export function UpNextCard({
  ...
  const href =
    `/programs/${programSlug}/sessions/${session.slug}`
  ...
  return (
    ...
    >
      <div className="relative aspect-video w-36 shrink-0 overflow-hidden rounded-lg bg-neutral-100">
        ...
        <Image
          src={
            getImageUrl(session.thumbnail_url) ||
      ...
      <div className="flex min-w-0 flex-col gap-1 pt-0.5">
        {highlighted && (
          <Caption
            variant="plain"
            className="text-[11px] font-medium uppercase tracking-wide text-neutral-900"
          >
            Up Next
          </Caption>
        )}
